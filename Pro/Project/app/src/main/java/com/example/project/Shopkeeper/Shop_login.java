...
public class Shop_login extends AppCompatActivity {
    ...
    // EditText name,address,locationmap,locationdistance;
    Button save;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* save = findViewById(R.id.save);
        ...
        mr = firebaseDatabase.getReference().child("Shopkeeper");
        ms = FirebaseStorage.getInstance();*/
        ...
        location= findViewById(R.id.location);
        spinner = findViewById(R.id.spinner);
        /*String arr={"Peddle the Blank Pages","Vend the Used Pages/Book","Reprocess Blank Pages","Reprocess used Pages/Books"};
        spinner.*/
        save = findViewById(R.id.save);
        imup = findViewById(R.id.imup);
        progressDialog=new ProgressDialog(this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data){
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!(fn.isEmpty() && dc.isEmpty() && dn.isEmpty() && tn.equals("Select Temple")&& image.isEmpty())) {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            Task<Uri> downloadurl=taskSnapshot.getStorage().getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    ...
                                    //Intent intent = new Intent(Shop_login.this, .class);
